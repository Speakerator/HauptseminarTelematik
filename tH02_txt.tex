...
\begin{figure}[htb] 
\centerline{\includegraphics*[width=1\textwidth]{img/JIT_vs_AOT.PNG}} 
\caption{Absolute performance of SciMark C/C# Benchmark Suite, native execution, pre-compiled (AOT) and JIT as well as sandbox slowdown in parantheses\cite{t02_Ansel}} 
